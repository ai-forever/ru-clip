...
from deprecated.clip.model import get_image_batch, GPT2Model, load, VisualEncoder, TextEncoder, CLIP
import os
import skimage
...
from deprecated.clip.download_utils import download_file_from_hf
